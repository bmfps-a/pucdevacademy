...
<head>
    ...
    <title>Cadastro para Alunos</title>
</head>
<body style="background-color: #171810;">
            ...
            <form id="registrar" action="cadastro-usuario-bd.php" method="post">
                <div class="row mb-3">
                    <div class="col-lg-6">
                        ...
                        <input type="text" class="form-control" id="nome" name="nome" pattern="(?:[A-Za-zÀ-ÖØ-öø-ÿçÇ\s]*[A-Za-zÀ-ÖØ-öø-ÿçÇ]){4}[A-Za-zÀ-ÖØ-öø-ÿçÇ\s]*" maxlength="50" required>
                    </div>
                    <div class="col-lg-6">
    ...
    <script src="../cadastro/validacaouser.js"></script>
</body>
</html>
