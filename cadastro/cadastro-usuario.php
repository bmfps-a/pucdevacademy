...
<body style="background-color: #171810;">
            ...
            <form id="registrar">
                <div class="row mb-3">
                    <div class="col-lg-6">
                        ...
                        <input type="text" class="form-control" id="nome" name="nome" pattern="[A-Za-zÀ-ÖØ-öø-ÿçÇ\s]{1,50}" required>
                    </div>
                    <div class="col-lg-6">
                ...
                <div class="row mb-3">
                    <div class="col-lg-6">
                        ...
                        <input type="password" class="form-control" id="senha" pattern=".+" required>
                    </div>
                    <div class="col-lg-6">
    ...
    <script src="../js/validacaouser.js"></script>
</body>
</html>
