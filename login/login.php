...
<body class="d-flex justify-content-center align-items-center vh-100">
  <div class="p-4">
      <div class="container">
        <a href="/homepage/index.html" class="btn-voltar" ><i class="bi bi-arrow-left"></i><span id="btnBack">Voltar</span></a>  
        <div class="row">
                  ...
                  <div class="formContainer">
                      ...
                      <form action="#">
                          ...
                          <div class="form-group mt-3">
                              ...
                              <input class="form-control" id="password" name="password" placeholder="password" type="password" pattern=".+" required maxlength="50"/>
                          </div>
                          <div class="mt-3">
